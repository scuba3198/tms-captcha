...
## ✨ New in v0.7.3
- **Bundling Optimization**: Refactored exports to improve `esbuild` minification compatibility, resolving the `solveCaptcha is not defined` runtime error.
- **Runtime Fix (v0.7.2)**: Restored missing `solveCaptcha` import in content script.
